...
In this presentation, we will explore the evolution of information access, from the early days of limited resources to the current era of abundant information at our fingertips. We will look how artificial intelligence is already augmenting the current tools we use and how it could help humans in the future.

- 📹 [Video](https://www.youtube.com/watch?v=sUz8JE7fuFA)
- 📊 [Slides](presentations/2024_CloudSummit_AI_Everything_Everywhere_All_at_Once.pdf)
- 🌐 [Cloud Summit 2024](https://web.archive.org/web/20240420184736/https://www.cloudsummit.pt/)
- 📅 April 2nd, 2024
